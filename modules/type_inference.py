...
MISSING_STRINGS = {"", "na", "n/a", "null", "none", "nan", ".", "-999", "missing"}
...
def _looks_like_datetime(series: pd.Series) -> bool:
    ...
    if not any(k in col_name for k in hints):
        return False
